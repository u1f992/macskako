...
const vivliostyleConfig = {
  title: "ポラーノの広場", // populated into 'publication.json', default to 'title' of the first entry or 'name' in 'package.json'.
  author: "宮沢賢治", // default to 'author' in 'package.json' or undefined
  language: "ja",
